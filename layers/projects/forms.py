...
class NewProject(forms.ModelForm):
	...
	description = forms.CharField(label="Give Your Project A Description *", widget=forms.Textarea(attrs={"class":'form-control', 'placeholder':"Fill out the forms below to describe your product idea. This brief will be reviewed and used by your designer to bring your idea to life."}))
